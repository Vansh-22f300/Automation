...
## 1. Orient
- Read the `build-order-status.md` Claude memory to confirm which step is current and
  the binding decisions. Read `CLAUDE.md` conventions if not already in context.
