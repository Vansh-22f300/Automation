...
ALTER TABLE "workflow_runs" ADD CONSTRAINT "workflow_runs_tenant_id_id_key" UNIQUE("tenant_id","id");--> statement-breakpoint
...
CREATE INDEX "jobs_running_lease_expires_at_idx" ON "jobs" USING btree ("lease_expires_at") WHERE "jobs"."status" = 'running';